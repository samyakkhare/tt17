...
if (isset($_GET['err'])) {
if ($_GET['err']==1) {
phpAlert($_SESSION['firstname_error'],$_SESSION['lastname_error'],$_SESSION['email_error'],$_SESSION['phnow_error'],$_SESSION['regno_error'],$_SESSION['pref_error'],$_SESSION['exist_error']);
  }
}

function phpAlert($msg,$msg2,$msg3,$msg4,$msg5,$msg6,$msg7) {
    echo '<script type="text/javascript">alert("' . $msg . $msg2 .$msg3 .$msg4 .  $msg5  . $msg6 . $msg7 .'");</script>';
}
